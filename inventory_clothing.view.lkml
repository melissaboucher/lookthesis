...
#joins rows from adidas, jordan, nike, off-white, kith, yeezy
  derived_table: {
    sql: (
      ...
      UNION ALL
      SELECT brand, item_name, average_price, ask_count, bid_count, total_sale, total_sale_count, volatility, size, retail_price, image_url, release_date FROM `lookerdata.StockX.supreme_clothing`    );;
  }
